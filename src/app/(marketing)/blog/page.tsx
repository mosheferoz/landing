        ...
        <Wrapper className="py-20">
            ...
            <Container delay={0.2}>
                <div className="flex items-center justify-center gap-3 mt-12 flex-wrap">
                    {CATEGORIES.map((category) => (
                        <button
                            key={category}
                            className="px-4 py-2 rounded-full border border-border/50 bg-card/30 hover:bg-card/50 hover:border-blue-500/50 transition-all text-sm font-medium"
                        >
                            {category}
                        </button>
                    ))}
                            ...
                            <div className="grid lg:grid-cols-2 gap-8 p-8 md:p-12">
                                <div className="flex flex-col justify-center">
                                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 w-fit mb-4">
                                        <span className="text-xs text-blue-500 font-medium">מומלץ</span>
                                    </div>
                                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-medium !leading-tight mb-4 group-hover:text-blue-500 transition-colors">
                                        {post.title}
                                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 max-w-6xl mx-auto">
                    {BLOG_POSTS.filter(post => !post.featured).map((post, idx) => (
                        <Link 
                            ...
                            className="group"
                        >
                            <div className="flex flex-col h-full rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 hover:border-blue-500/50 transition-all overflow-hidden">
                                ...
                                <div className="flex flex-col flex-1 p-6">
                                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 w-fit mb-3">
                                        <span className="text-xs text-blue-500 font-medium">{post.category}</span>
                                    </div>
                                    <h3 className="text-xl font-heading font-medium mb-3 group-hover:text-blue-500 transition-colors">
                                        {post.title}
                                    </h3>
            ...
            <Container delay={0.5}>
                <div className="relative max-w-4xl mx-auto mt-32">
                    ...
                    <div className="relative border border-blue-500/30 rounded-3xl p-8 md:p-12 bg-card/30 backdrop-blur-sm text-center">
