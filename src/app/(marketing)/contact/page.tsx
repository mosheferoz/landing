            ...
            <Container delay={0.2}>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-16">
                    <div className="flex flex-col items-center text-center p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 transition-all group">
                        ...
                        <a href="mailto:hello@lift14.com" className="text-blue-500 hover:underline text-sm">
                            hello@lift14.com
                        </a>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 transition-all group">
                        ...
                        <a href="tel:+972501234567" className="text-blue-500 hover:underline text-sm">
                            050-123-4567
                        </a>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 transition-all group">
                        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            <MessageSquareIcon className="w-7 h-7 text-blue-500" />
                        </div>
                ...
                <div className="max-w-4xl mx-auto mt-20">
                    <div className="grid lg:grid-cols-2 gap-12">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full px-4 py-3 rounded-xl bg-background/50 border border-border/50 focus:border-blue-500/50 focus:outline-none transition-colors text-right"
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            required
                                            rows={6}
                                            className="w-full px-4 py-3 rounded-xl bg-background/50 border border-border/50 focus:border-blue-500/50 focus:outline-none transition-colors resize-none text-right"
                        ...
                        <div className="order-1 lg:order-2 flex flex-col justify-center">
                            ...
                            <div className="mt-12 p-6 rounded-2xl bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/20">
            ...
            <Container delay={0.4}>
                <div className="max-w-4xl mx-auto mt-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <a href="/pricing#faq" className="p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 hover:border-blue-500/50 transition-all text-right group">
                            <h3 className="text-lg font-medium mb-2 group-hover:text-blue-500 transition-colors">איך עובדת יצירת התוכן בעזרת AI?</h3>
                            <p className="text-sm text-muted-foreground">למד על התהליך של יצירת תוכן מותאם אישית</p>
                        </a>
                        <a href="/pricing#faq" className="p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 hover:border-blue-500/50 transition-all text-right group">
                            <h3 className="text-lg font-medium mb-2 group-hover:text-blue-500 transition-colors">איזה סוג תמיכה אתם מספקים?</h3>
