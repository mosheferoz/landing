    ...
    return (
        <Wrapper className="py-20">
            <div className="relative flex flex-col items-center justify-center w-full">
                ...
                <div className="absolute flex lg:hidden size-40 rounded-full bg-brand-500 blur-[10rem] top-0 left-1/2 -translate-x-1/2 -z-10"></div>
                <div className="absolute top-40 left-1/2 -z-10 bg-gradient-to-r from-brand-500 to-brand-600 w-1/2 lg:w-2/3 -translate-x-1/2 h-1/4 blur-[4rem] lg:blur-[8rem] opacity-50"></div>
                ...
                <div className="flex flex-col items-center text-center max-w-3xl mx-auto pt-20">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brand-500/20 bg-brand-500/10 mb-6">
                        <SparklesIcon className="w-4 h-4 text-brand-500" />
                        <span className="text-sm text-brand-500 font-medium">פלטפורמה מופעלת בינה מלאכותית</span>
                    </div>
            ...
            <Container delay={0.3}>
                <div className="max-w-6xl mx-auto mt-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="flex flex-col p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 transition-all hover:border-brand-500/50 group">
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-500/20 to-brand-600/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                        ...
                        <div className="flex flex-col p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 transition-all hover:border-brand-500/50 group">
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-500/20 to-brand-600/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                <TrendingUpIcon className="w-6 h-6 text-brand-500" />
                            </div>
                        ...
                        <div className="flex flex-col p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 transition-all hover:border-brand-500/50 group">
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-500/20 to-brand-600/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                <ShieldIcon className="w-6 h-6 text-brand-500" />
                            </div>
            ...
            <Container delay={0.5}>
                <div className="relative max-w-5xl mx-auto mt-32">
                    ...
                    <div className="relative border border-brand-500/30 rounded-3xl p-8 md:p-12 lg:p-16 bg-card/30 backdrop-blur-sm text-center">
