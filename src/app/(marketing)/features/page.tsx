        ...
        <Wrapper className="py-20">
            <div className="relative flex flex-col items-center justify-center w-full">
                ...
                <div className="flex flex-col items-center text-center max-w-3xl mx-auto pt-20">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-500/20 bg-blue-500/10 mb-6">
                        ...
                        <span className="text-sm text-blue-500 font-medium">פלטפורמה מופעלת בינה מלאכותית</span>
                    </div>
            ...
            <Container delay={0.3}>
                <div className="max-w-6xl mx-auto mt-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="flex flex-col p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-card/50 transition-all hover:border-blue-500/50 group">
            ...
            <Container delay={0.5}>
                <div className="relative max-w-5xl mx-auto mt-32">
                    ...
                    <div className="relative border border-blue-500/30 rounded-3xl p-8 md:p-12 lg:p-16 bg-card/30 backdrop-blur-sm text-center">
