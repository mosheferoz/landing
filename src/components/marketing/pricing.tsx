                ...
                <Container>
                    <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                            מצא את התוכנית הנכונה שמתאימה <br className="hidden lg:block" /> <span className="font-subheading italic">לצרכים שלך</span>
                        </h2>
                        <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                            שנה את השיווק שלך עם אוטומציה מבוססת AI. צור קמפיינים מהר יותר, ייצר תוכן טוב יותר, וקבל החלטות חכמות יותר תוך דקות.
                        </p>
                    </div>
                </Container>
                        ...
                        <button onClick={handleSwitch} className="relative rounded-full focus:outline-none">
                            ...
                            <div
                                className={cn(
                                    ...
                                    billPlan === "annually" ? "right-1" : "left-1"
                                )}
                            />
                        </button>
                        <span className="text-base font-medium">שנתי</span>
                    </div>
                </Container>
            </div>
    ...
    return (
        <div className={cn(
            ...
            <div className="flex flex-col items-start w-full px-4 py-2 md:px-8">
                <Button size="lg" variant={plan.title === "מאסטרמיינד" ? "blue" : "white"} className="w-full">
                    {plan.buttonText}
                </Button>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {billPlan === "monthly" ? (
                                ...
                                "חיוב בתשלום שנתי אחד"
                            )}
                        </motion.span>
                    </AnimatePresence>
                </div>
            </div>
            <div className="flex flex-col items-start w-full p-5 mb-4 mr-1 gap-y-2">
                <span className="text-base text-right mb-2 w-full">
                    כולל: 
                </span>
                {plan.features.map((feature, index) => (
                    <div key={index} className="flex items-center justify-start gap-2 flex-row-reverse w-full">
